...
{
	Send, {blind}{%letters%}
	SearchString := SearchString letters  ; implicit
	searchChord(SearchString)
...
searchChord(ByRef SearchString)
{
	...
	Loop, Read, C:\Users\shant\Desktop\onehand-keyboard-AHK-scripts\chording_dictionary\mison.txt
		{
