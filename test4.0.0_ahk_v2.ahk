...
SetTimer(CheckTabChange, 250)  ; Check every 500ms
...
CheckTabChange() {
 ...
 ; Compare with the previous title
 if (currentTitle != "" && currentTitle != prevTabTitle) {
  prevTabTitle := currentTitle
...
VimModeLibrary() {
 ...
 VimStatusEl := UIA.ElementFromHandle("ahk_exe Code.exe")
